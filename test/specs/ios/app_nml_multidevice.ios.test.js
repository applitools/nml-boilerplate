...
describe('App NML - Perfecto', () => {
  ...
  before(async () => {
    ...
    eyes.setBatch(new BatchInfo('JS Perfecto | Static/Slicing Dynamic | NML | iOS Boilerplate | Multi Device'));

    // TODO: swap in your own app name/description here.
    await eyes.open(browser, 'Perfecto iOS App', 'iOS App Validation');
