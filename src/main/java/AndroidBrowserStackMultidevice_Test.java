...
/**
 * Boilerplate Android test — Applitools NML (multi-device) + BrowserStack Real Device
 *
 ...
 */
public class AndroidBrowserStackMultidevice_Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.setBatch(new BatchInfo("Java BrowserStack | NML | Android Boilerplate | Multi Device"));
